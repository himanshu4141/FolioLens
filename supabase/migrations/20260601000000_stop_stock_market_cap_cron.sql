...
-- backup mfdata (`amfi`) classifier. See docs/plans/deprecate-stock-market-cap.md.
--
...
--
-- Phase 2 (gated, same PR before merge): DROP the table and remove the
-- classifier from `sync-fund-portfolios` / `fetch-fund-snapshot`.
--
