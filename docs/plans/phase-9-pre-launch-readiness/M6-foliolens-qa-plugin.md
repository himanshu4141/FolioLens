...
- `foliolens-qa-skill/references/app-reference.md` contains shared routes, cache keys, theme rules, and report templates.
...
- Convert the three Claude QA skills into Codex skills under `plugins/foliolens-qa/skills/`.
- Add a shared `app-reference.md` for routes, expected behavior, cache keys, theme rules, known bug classes, and report templates.
...
2. Convert the three QA skills.
   - Expected outcome: `qa-pr`, `qa-smoke`, and `qa-regression` each have valid `SKILL.md` frontmatter and workflow instructions.
   - Validation: run the skill quick validator on each skill directory.
3. Add the shared FolioLens app reference.
   - Expected outcome: all skills point to `../references/app-reference.md`.
...
Run:
    ...
    python3 /Users/hyadav/.codex/skills/.system/skill-creator/scripts/quick_validate.py plugins/foliolens-qa/skills/qa-pr
    python3 /Users/hyadav/.codex/skills/.system/skill-creator/scripts/quick_validate.py plugins/foliolens-qa/skills/qa-smoke
    python3 /Users/hyadav/.codex/skills/.system/skill-creator/scripts/quick_validate.py plugins/foliolens-qa/skills/qa-regression
