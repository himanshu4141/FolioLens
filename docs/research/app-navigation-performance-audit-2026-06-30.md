...
| 6 | N3 | Merged | [#256](https://github.com/himanshu4141/FolioLens/pull/256) | `d75a5920` | Codex/Claude CONVERGED at docs head `85b73945` / measured code `44638de3`; 83 suites / 1,870 tests, typecheck, zero-warning lint, Android export, and diff check; exact-SHA Android PR-preview retained visible Direct vs Regular work while hidden Portfolio/timeline/Money Trail/Wealth Journey stayed dormant, with deterministic tests covering changed-row tx/NAV/index tool invalidation; the separate reproducible persister `SQLITE_FULL` is retained for N8 |
