...
| 3 | N2D | Changes requested | [#253](https://github.com/himanshu4141/FolioLens/pull/253) | — | Codex reviewed `715ec3c3`: carry the pre-roster-I/O write scope through sync and key bootstrap/delta single-flight state by user + generation; add cross-cleanup old/new-user race coverage; Android main-preview evidence pending |
