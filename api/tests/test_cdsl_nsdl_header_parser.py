...
@pytest.mark.parametrize(
    "folio_cells",
    [
        ["Folio No :", "ISIN", "INF000A00001"],
        ["Folio No :", "Mode of Holding : Single", "123"],
    ],
)
def test_delimited_folio_does_not_skip_a_non_folio_neighbour(folio_cells):
    header = ["Date", "Description", "Amount", "NAV", "Price", "Units"]
    row = ["01-07-2026", "Purchase", "1000", "100", "100", "10"]
    table = _table(header, row)
    table[0] = [*folio_cells, None, None, None]
