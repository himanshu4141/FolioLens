...
- **Agent QA workflows** — repo-local Codex plugin `plugins/foliolens-qa` packages repeatable PR QA, production smoke, and full regression skills with FolioLens-specific route, cache, theme, and report templates.
