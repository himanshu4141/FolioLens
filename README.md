...
- **Portfolio / Home screen** — Clear Lens design: hero value, NAV staleness context, XIRR vs configurable benchmark, investment-vs-benchmark chart with `1M / 3M / 6M / 1Y / 3Y / All` ranges, top movers, allocation preview, Portfolio Insights entry, Your Funds entry, Wealth Journey, Money Trail preview. Mobile web and native builds persist shared NAV / benchmark history locally and refresh it with delta fetches so returning to Portfolio does not redownload unchanged history.
