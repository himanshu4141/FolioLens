...
describe('tx repo', () => {
  it('bulkInsert + readAll', async () => {
    await txRepo.bulkInsert([
      { fund_id: 'f1', transaction_date: '2024-01-01', transaction_type: 'purchase', units: 100, amount: 10000 },
      { fund_id: 'f1', transaction_date: '2024-06-01', transaction_type: 'purchase', units: 50, amount: 6000 },
      { fund_id: 'f2', transaction_date: '2024-03-01', transaction_type: 'purchase', units: 200, amount: 20000 },
    ]);
  ...
  it('readByFundId filters by fund_id', async () => {
    await txRepo.bulkInsert([
      { fund_id: 'f1', transaction_date: '2024-01-01', transaction_type: 'purchase', units: 100, amount: 10000 },
      { fund_id: 'f2', transaction_date: '2024-02-01', transaction_type: 'purchase', units: 200, amount: 20000 },
    ]);
